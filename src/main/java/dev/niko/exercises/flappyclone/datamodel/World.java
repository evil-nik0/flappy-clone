...
public class World {
	public static double worldW = 4144, worldH = 2331; // se puede colocar cualquier tamaño para el mundo virtual y para la resolución de la ventana, pero deben mantener
